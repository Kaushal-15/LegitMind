  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-background text-foreground">
      ...
      <div className="absolute top-8 left-8 z-10">
        <Logo className="[&>span]:text-white [&>svg]:text-primary-foreground" />
      </div>

      <div className="relative z-10 flex flex-col items-center text-center px-4">
        <h1 className="font-headline text-6xl md:text-8xl font-bold text-white">
          LegitMind
        </h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          <Button asChild size="lg" variant="outline" className="bg-transparent border-primary/50 text-white hover:bg-primary/10 hover:text-white">
